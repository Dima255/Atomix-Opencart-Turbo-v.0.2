...
define('GITHUB_MY_URL', 'https://github.com/Dima255/Atomix-Opencart-Turbo-v.0.2');
// Set the time zone
...
<body>
  ...
  <div class="container">
    <div class="well">
	  ...
	  <li>Русифицированный скрипт на GitHub: <a href="<?php echo GITHUB_MY_URL; ?>" target="_blank"><?php echo GITHUB_MY_URL; ?></a>.</li>
        </ul>
      </p>
    </div>
